...
export default function Hero20() {
  return (
    <section className="video-wrapper bg-overlay bg-overlay-gradient px-0 mt-0 min-vh-80">
      <video loop muted autoPlay playsInline id="1187841" src="/media/movie2.mp4" poster="/img/photos/movie2.jpg" />
          ...
          <div className="row">
            <div className="col-lg-8 col-xl-6 text-center text-white mx-auto">
              <h1 className="display-1 fs-54 text-white mb-5">
                <ReplaceMe className="rotator-zoom">Rapid Solutions,Innovative Thinking,Top-Notch Support</ReplaceMe>
              </h1>
