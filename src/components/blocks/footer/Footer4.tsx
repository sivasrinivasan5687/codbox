				...
				<div className="row gy-6 gy-lg-0">
					<div className="col-md-4 col-lg-3">
						<div className="widget">
							...
							<p className="mb-4">
								© 2025 EVIANSINTL. <br className="d-none d-lg-block" />
								All rights reserved.
							</p>
					...
					<div className="col-md-4 col-lg-3">
						<div className="widget">
							...
							<address className="pe-xl-15 pe-xxl-17">63 WINLATON ROAD,BROMLEY,ENGLAND BR1 5PU.</address>
							<NextLink title="info@eviansintl.io" href="mailto:info@eviansintl.io" className="link-body" />
							<br />
							+1 (908) 455-8007
						</div>
					</div>
